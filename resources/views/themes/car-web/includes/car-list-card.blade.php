        ...
        <div class="card-description">
            <div class="card-caption">
                <a href="{{ $car->slug }}" target="_blank">
                    ...
                    <div class="meta">{{ $car->metaValue('buildYear') }}/{{ $car->metaValue('importDate') }} | {{ $car->metaValue('mileageAmount')?number_format($car->metaValue('mileageAmount')):'0' }} {{ $car->metaValue('mileageUnit') }}</div>
